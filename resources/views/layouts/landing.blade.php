...
<head>
    ...
    <!-- SlickNav Css -->
    <link href="landing/css/slicknav.min.css" rel="stylesheet">
    <!-- Swiper Css -->
    <link rel="stylesheet" href="landing/css/swiper-bundle.min.css">
    <!-- Font Awesome Icon Css-->
    <link href="landing/css/all.min.css" rel="stylesheet" media="screen">
    <!-- Animated Css -->
    <link href="landing/css/animate.css" rel="stylesheet">
    <!-- Magnific Popup Core Css File -->
    <link rel="stylesheet" href="landing/css/magnific-popup.css">
    <!-- Mouse Cursor Css File -->
    <link rel="stylesheet" href="landing/css/mousecursor.css">
    <!-- Main Custom Css -->
    <link href="landing/css/custom.css" rel="stylesheet" media="screen">
</head>
...
<body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse main-menu">
                        <div class="nav-menu-wrapper">
                            <ul class="navbar-nav mr-auto" id="menu">
                                <li class="nav-item submenu"><a class="nav-link" href="index.html">Home</a>
                                    <ul>
                                        <li class="nav-item"><a class="nav-link" href="index-2.html">Home - Version
                                                1</a></li>
                                        <li class="nav-item"><a class="nav-link" href="index-3.html">Home - Version
                                                2</a></li>
                                        <li class="nav-item"><a class="nav-link" href="index-4.html">Home - Version
                                                3</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item submenu"><a class="nav-link" href="#">Pages</a>
                                    <ul>
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="schedule-single.html">schedule
                                                Details</a></li>
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="speaker-single.html">Speaker
                                                Details</a></li>
                        ...
                        <div class="header-btn">
                            <a href="contact.html" class="btn-default btn-highlighted">Join the Conference</a>
                        </div>
                        <!-- Header Btn End -->
                    </div>
                    <!-- Main Menu End -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="footer-header">
                        ...
                        <div class="section-title">
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Join our newsletter for event important
                                announcement</h2>
                        </div>
                        <!-- Section Title End -->
                ...
                <div class="col-xl-4">
                    ...
                    <div class="about-footer">
                        ...
                        <div class="about-footer-content">
                            <p>Experience a world-class conference designed to inspire innovation, empower
                                professionals, and connect leaders from around the globe.</p>
                        </div>
                    ...
                    <div class="footer-links-box">
                        ...
                        <div class="footer-links footer-contact-links">
                            ...
                            <ul>
                                ...
                                <li><a href="mailto:support@domainname.com">support@domainname.com</a></li>
                            </ul>
    ...
    <!-- Jquery Library File -->
    <script src="landing/js/jquery-3.7.1.min.js"></script>
    <!-- Bootstrap js file -->
    ...
    <!-- Parallax js -->
    <script src="landing/js/parallaxie.js"></script>
    <!-- MagicCursor js file -->
    <script src="landing/js/gsap.min.js"></script>
    <script src="landing/js/magiccursor.js"></script>
    <!-- Text Effect js file -->
    <script src="landing/js/SplitText.min.js"></script>
    <script src="landing/js/ScrollTrigger.min.js"></script>
    <!-- YTPlayer js File -->
