...
new class extends Component {
    ...
    public function mount(Seminar $seminar)
    {
        ...
        $this->description = $this->seminar->description;
        $this->location = $this->seminar->location;
        $this->date_start = $seminar->date_start?->format('Y-m-d\TH:i');
        $this->quota = $this->seminar->quota;
        $this->price = Number::parseInt($this->seminar->price);
        $this->status = $this->seminar->status->value;
        $this->created_by = $this->seminar->created_by;
    }
    ...
    public function submit()
    {
        ...
        try {
            ...
            if ($repo->update($this->seminar, $data)) {
